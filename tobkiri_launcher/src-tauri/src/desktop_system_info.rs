    ...
    vec![
        host_permission_row(
            HostPermissionSpec {
                ...
                detail: "Capture microphone input after Rumi approval. Raw audio is not stored by defaultspack.",
        ...
        host_permission_row(
            HostPermissionSpec {
                ...
                detail: "Capture system audio after Rumi approval. Raw audio is not stored by defaultspack.",
                settings_hint: "",
            },
            os_permissions,
        ),

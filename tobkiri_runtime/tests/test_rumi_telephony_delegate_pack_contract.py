...
OVERLAP_EXPECTED = {'actual_dialing': 'blocked_handoff_to_defaultspack_tool_runtime', 'asr_tts_runtime': 'handoff_to_defaultspack_tool_runtime', 'media_transcript_runtime': 'handoff_to_defaultspack_tool_runtime', 'contact_or_calendar_lookup': 'handoff_to_defaultspack_tool_runtime', 'meeting_recap': 'handoff_to_rumi_local_agent_pack', 'external_business_action': 'handoff_to_rumi_operations_team_pack', 'real_world_action_risk_review': 'handoff_to_rumi_operations_team_pack', 'telephony_contract': 'owned_by_rumi_telephony_delegate_pack', 'tool_aliases': 'prefer_explicit_pack_namespace'}
...
PROMOTION_EVIDENCE = set(['mock_dial_approval_cases', 'never_call_block_cases', 'transcript_redaction_cases', 'takeover_escalation_cases', 'operations_team_takeover_acceptance_cases', 'provider_handoff_acceptance_cases'])

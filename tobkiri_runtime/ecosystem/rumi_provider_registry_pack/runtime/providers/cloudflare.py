"""Cloudflare connection catalog owned by the provider registry Pack."""
...
CLOUDFLARE_PROVIDER = ConnectionProvider(
    ...
    adapter={
        "python": "ecosystem.rumi_provider_registry_pack.runtime.connection_adapters:CloudflareConnectionAdapter",
        "sdk_optional": True,
    },
    metadata={

...
_ALWAYS_AVAILABLE_HTTP_ROUTE_SPECS = [
    ...
    HttpRouteSpec("POST", "/api/local-auth/exchange", handler_name="_handle_local_auth_exchange"),
    HttpRouteSpec("POST", "/api/local-auth/exchange/redeem", handler_name="_handle_local_auth_exchange_redeem"),

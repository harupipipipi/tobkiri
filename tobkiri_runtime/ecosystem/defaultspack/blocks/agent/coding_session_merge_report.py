...
def run(input_data, context=None):
    ...
    report = MultiAgentOrchestrator().merge_report(session)
    session.shared_context.setdefault("workspace", {})["merge_report"] = report
    return ok({"session_id": session_id, "merge_report": report})

...
def run(context):
    ...
    routes = [
        ...
        ("GET", "/api/coding/codex-app-server", _lazy("blocks.coding.codex_runtime", "status"), {}),
        ("POST", "/api/coding/codex-app-server/turns", _lazy("blocks.coding.codex_runtime", "start"), {}),
        ("POST", "/api/coding/codex-app-server/interrupt", _lazy("blocks.coding.codex_runtime", "interrupt"), {}),

...
from blocks.change_request._helpers import mutation_conflict_response, not_found_response, service, service_error_response
...
def run(input_data, context=None):
    ...
    try:
        return ok(service().refresh(str(input_data.get("id") or ""), input_data))
    except KeyError:

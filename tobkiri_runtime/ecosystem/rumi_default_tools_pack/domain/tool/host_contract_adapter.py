"""Finite legacy browser/computer tool projection onto Wave 8 contracts."""
...
_ACTION_MAP: Final[dict[str, tuple[str, str]]] = {
    ...
    "browser.profile.clear_cache": (BROWSER_CONTROL, "browser.profile.clear_cache"),
    "browser.profile.clear_cookies": (BROWSER_CONTROL, "browser.profile.clear_cookies"),
    ...
    "computer.ax_tree": (DESKTOP_OBSERVE, "desktop.accessibility.snapshot"),
    ...
    "computer.semantic_action": (DESKTOP_CONTROL, "desktop.accessibility.action"),
    "computer.click_text": (DESKTOP_CONTROL, "desktop.accessibility.action"),
    "computer.pid_event": (DESKTOP_CONTROL, "desktop.accessibility.action"),
...
def run_host_contract_action(
    ...
    *,
    ...
    """Project one legacy action onto an active Wave 8 provider."""
